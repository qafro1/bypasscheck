...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', '--path', type=str, help='path to check (domain.com)')
    group = parser.add_mutually_exclusive_group(required=True)
    group.add_argument('-d', '--domains', help="domains to check (filename.txt)")
    group.add_argument('-t', '--target', help="domain to check (site.com)")
    parser.add_argument('-f', '--file', help="file containing multiple API endpoints (endpoints.txt)")
    parser.add_argument('-o', '--output', help="output file path (output.txt)")
